...
public class EventSQLiteHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    private static final String EVENT_STATS_TABLE_CREATE = "CREATE TABLE "
            ...
            + EventFieldNameDictionary.LIKED_BY_ME + " INTEGER, "
    ...
    private static final String EVENT_ADVERT_TABLE_CREATE = "CREATE TABLE "
            ...
            + EventFieldNameDictionary.ADVERT.EVENT_START_AT + " INTEGER NOT NULL, "
            + EventFieldNameDictionary.ADVERT.EVENT_END_AT + " INTEGER NOT NULL, "
            + EventFieldNameDictionary.ADVERT.ADVERT_START_AT + " INTEGER NOT NULL, "
            + EventFieldNameDictionary.ADVERT.ADVERT_END_AT + " INTEGER NOT NULL, "
            + EventFieldNameDictionary.ADVERT.LOGO_THUMB + " TEXT, "
            + EventFieldNameDictionary.ADVERT.LOGO_ORIGINAL + " TEXT, "
            + EventFieldNameDictionary.ADVERT.POSTER_BLUR + " TEXT, "
            + EventFieldNameDictionary.ADVERT.POSTER_ORIGINAL + " TEXT, "
            + EventFieldNameDictionary.ADVERT.POSTER_THUMB + " TEXT, "
            + EventFieldNameDictionary.ADVERT.TEXT + " TEXT, "
            + EventFieldNameDictionary.ADVERT.FLAYER + " TEXT, "
